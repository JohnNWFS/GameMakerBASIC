...
add(100,"IF T$=\"0\" THEN GOTO 9000");
add(110,"T=VAL(T$)");
add(112,"IF T<1 OR T>TOPIC_COUNT THEN GOTO 880");
add(120,"REM --- SUBTOPIC MENU LOOP ---");
add(130,"CLS: HDR$=\"TOPIC: \" + TOPIC$(T) + \"  (0=Back)\": GOSUB 7000");
add(140,"C=0");
add(150,"FOR I=1 TO SUB_COUNT");
add(160,"IF SUBTOPIC_OF(I)<>T THEN GOTO 170");
add(162,"C=C+1");
add(164,"PRINT C; \") \"; SUB$(I)");
add(166,"IDX(C)=I");
add(170,"NEXT");
add(180,"IF C=0 THEN GOTO 860");
add(190,"PRINT");
add(200,"INPUT \"Subtopic (0=Back): \", K$");
add(210,"IF K$=\"0\" THEN GOTO 50");
add(213,"K=VAL(K$)");
add(222,"IF K<1 OR K>C THEN GOTO 190");
add(230,"REM --- SHOW CONTENT ---");
add(240,"I = IDX(K): S = SUB_START(I): N = SUB_LEN(I)");
add(250,"GOSUB 8000");
add(260,"GOTO 120");
add(860,"PRINT \"(No subtopics)\"");
add(862,"INPUT \"[ENTER]\", X$");
add(864,"GOTO 50");
add(880,"PRINT \"Invalid.\"");
add(882,"GOTO 80");
add(9000,"END");
...
add(9942,"DATA \"MODE 2 & Fonts\", 5, 15, 2");
...
add(10018,"DATA \"SCREENEDIT/SE=screen editor; TILEEDIT/TE=tile painter\"");
...
add(10177,"DATA \"See also: MODE 2, PRINTAT\"");
add(10178,"DATA \"\"");
...
add(10278,"DATA \"\"");
add(10280,"REM === Page 15: MODE / Graphics / MODE2 & Fonts p1 ===");
add(10290,"DATA 8");
add(10291,"DATA \"MODE 2 & FONTS - Part 1\"");
...
add(10298,"DATA \"\"");
add(10300,"REM === Page 16: MODE / Graphics / MODE2 & Fonts p2 ===");
add(10310,"DATA 7");
add(10311,"DATA \"MODE 2 & FONTS - Part 2\"");
...
add(10334,"DATA \"Syntax: CHARAT/TILE/PLOT x,y,code[,fg[,bg]]\"");
add(10335,"DATA \"Type: PRINTAT 1,1,\"\"TOP\"\"\"");
add(10336,"DATA \"Type: TILE 10,5,45  ' draw '-'\"");
add(10337,"DATA \"See also: MODE 2, CLSCHAR/SCROLL\"");
add(10338,"DATA \"\"");
add(10340,"REM === Page 18: MODE / Graphics / PRINTAT-CHARAT p2 ===");
add(10350,"DATA 7");
add(10351,"DATA \"PRINTAT / CHARAT - Part 2\"");
add(10352,"DATA \"Tip: DRAWSTR is an alias for PRINTAT.\"");
add(10353,"DATA \"Tip: BOX/FILL/HLINE/VLINE draw tile shapes.\"");
add(10354,"DATA \"Tip: TILECHAR/TILECOLOR read cells.\"");
add(10355,"DATA \"Tip: TILEDEF/TILEPX edit custom tiles.\"");
add(10356,"DATA \"Tip: TILERESTORE returns to font glyph.\"");
add(10357,"DATA \"Tip: TILESAVE/TILELOAD store tile masks.\"");
add(10358,"DATA \"See also: MODE 2, DIR Overlay\"");
add(10359,"DATA \"\"");
...
add(10657,"DATA \"TILEEDIT or TE to paint custom MODE 2 tiles.\"");
add(10658,"DATA \"See also: SAVE/LOAD\"");
