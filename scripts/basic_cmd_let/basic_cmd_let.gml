// FILE: scripts/basic_cmd_let.gml
// FUNCTION: basic_cmd_let
// CHANGE: Remove INKEY$ blocking logic, evaluate via basic_evaluate_expression_v2
...
function basic_cmd_let(arg) {
    ...
    if (dbg_on(DBG_FLOW))  show_debug_message("LET: Assigned value: '" + string(result) + "' to '" + varname + "'");
     if (is_string(result)) {
