function basic_evaluate_condition(expr) {
    ...
    show_debug_message("COND: No operator; evaluating whole expression for truthiness");
    ...
    show_debug_message("COND: expression value=" + string(_val) + " → truth=" + string(_truth));
    return _truth;
}
