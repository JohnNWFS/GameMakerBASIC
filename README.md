...
10 MODE 2
20 GOSUB 200
30 PRINTAT 0, 11, "Press ENTER to scroll up 3...", YELLOW, BLACK
40 PAUSE
50 SCROLL UP, 3
60 GOSUB 200
70 PRINTAT 0, 11, "Press ENTER to scroll down 1...", YELLOW, BLACK
80 PAUSE
90 SCROLL DOWN, 1
100 GOSUB 200
...
130 SCROLL LEFT, 2
140 GOSUB 200
150 PRINTAT 0, 11, "Press ENTER to scroll right 1...", YELLOW, BLACK
160 PAUSE
170 SCROLL RIGHT, 1
180 END
200 CLSCHAR 32, BLACK, BLACK
210 FOR I = 1 TO 10
220   PRINTAT 0, I-1, "Row " + STR$(I), WHITE, BLACK
230 NEXT I
240 RETURN
```
